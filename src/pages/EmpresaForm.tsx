...
import { ArrowLeft, Save, Building2, Link as LinkIcon } from 'lucide-react'
    ...
    <div className="flex flex-col h-[calc(100vh-3.5rem)] -mx-4 -mt-4 bg-slate-50 text-slate-800 font-sans">
      <div className="flex items-center justify-between px-6 py-3 bg-white border-b shadow-sm z-10 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={handleSave} className="h-9 bg-primary hover:bg-primary/90 text-white">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="flex-1 bg-white overflow-y-auto p-8 space-y-10">
          <section className="space-y-6">
            <div className="flex items-center justify-between border-b pb-2">
              <h2 className="text-lg font-bold text-slate-700">Informações Principais</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2 md:col-span-2">
                <Label className="text-slate-600 font-semibold">Breve descrição da empresa</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label className="text-slate-600 font-semibold">Pipeline Alvo</Label>
                <Select
              ...
              <div className="space-y-2">
                <Label className="text-slate-600 font-semibold">Origem do Lead</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="Formulário do site da Transzecão">
                      Formulário do site da Transzecão
                    </SelectItem>
                    <SelectItem value="Setor Coleta">Setor Coleta</SelectItem>
                    <SelectItem value="Comercial">Comercial</SelectItem>
                    <SelectItem value="Outra origem configurável">
                      Outra origem configurável
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label className="text-slate-600 font-semibold flex items-center gap-1">
                  <LinkIcon className="w-3 h-3" /> Link do site prospectado
                </Label>
                <Input
              ...
              <div className="space-y-2">
                <Label className="text-slate-600 font-semibold flex items-center gap-1">
                  <LinkIcon className="w-3 h-3" /> Link de Pesquisa (LinkedIn)
                </Label>
                <Input
