        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main className="flex-1 flex flex-col p-3 md:p-6 overflow-auto">
            ...
            <footer className="mt-12 py-6 border-t border-slate-200 flex flex-col items-center justify-center text-slate-500">
              <div className="font-bold text-2xl tracking-tighter flex items-center gap-1 mb-1 opacity-50 grayscale">
                <span className="font-sans font-bold text-slate-800">
                  trans<span className="text-primary font-black">Zecão</span>
                </span>
              </div>
