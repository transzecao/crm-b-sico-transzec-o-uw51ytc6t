...
export function AppSidebar() {
  ...
  const items = [
    ...
    },
    {
      ...
      url: '/empresas',
      icon: Building2,
      roles: ['Master', 'Supervisor', 'Comercial', 'Coleta', 'Diretoria'],
    },
    {
      title: 'Contatos',
      url: '/contatos',
    ...
    },
    {
      ...
      url: '/roteirizacao',
      icon: MapIcon,
      roles: ['Master', 'Supervisor', 'Coleta', 'Diretoria'],
    },
    {
      title: 'Módulo Financeiro',
      url: '/financeiro',
      icon: DollarSign,
      roles: ['Master', 'Supervisor', 'Financeiro', 'Comercial', 'Diretoria'],
    },
    {
      title: 'Analytics',
      url: '/analytics',
      icon: BarChart3,
      roles: ['Master', 'Supervisor', 'Diretoria', 'Comercial'],
    },
    {
      title: 'Governança',
      url: '/admin/logins',
